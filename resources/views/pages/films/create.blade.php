  ...
  <section class="container mx-auto p-4 flex flex-col gap-4">
    ...
    <form action="/films" method="POST" enctype="multipart/form-data" class="flex flex-col gap-4">
      ...
      <div class="flex flex-col gap-2">
        ...
        <input id="title" name="title" type="text" placeholder="Type here" class="input input-bordered input-accent w-full" />
      </div>
      <div class="flex gap-4">
        <div class="flex-1 flex flex-col gap-2">
          <label for="year" class="block">Year</label>
          <input id="year" name="year" type="number" step="1" placeholder="Year Released" class="input input-bordered input-accent w-full" />
        </div>
        <div class="flex-1 flex flex-col gap-2">
      ...
      <div class="flex flex-col gap-2">
        ...
        <textarea id="summary" name="summary" rows="10" class="textarea textarea-accent" placeholder="About this film ..."></textarea>
      </div>
